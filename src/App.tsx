    ...
    <main className={'app app--' + stage}>
      ...
      <section className="app__permissions">
        ...
        <div className="app__permission-badges">
          <span className={`app__permission-badge app__permission-badge--${cameraPermission}`}>Camera: {cameraPermission}</span>
          <span className={`app__permission-badge app__permission-badge--${microphonePermission}`}>Microphone: {microphonePermission}</span>
        </div>
